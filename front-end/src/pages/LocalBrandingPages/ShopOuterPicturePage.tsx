...
import { ShopOuterCardState } from '../../recoils/ShopOuterRecoil.tsx'
...
function ShopInnerPicturePage() {
  ...
  const [cardData, setCardData] = useRecoilState(ShopOuterCardState);
  useEffect(() => {
  ...
  return (
    <FullSizeContentLayout size="lg">
      <HeaderForChangingWorks_1_1_1
        ...
        CompThree={<DragAndDropHeadList cardData={ cardData } reOrderCardData={ handleReordering }/>}
